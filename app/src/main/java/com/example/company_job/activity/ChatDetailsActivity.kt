...
import com.example.company_job.adapter.ChatDetailListAdapter
...
import com.example.company_job.utilities.CustomToast
...
//        actionBar!!.title = friend!!.nama
        ...
        val dbRefUser = FirebaseDatabase.getInstance().getReference("users/${friend!!.id}")
